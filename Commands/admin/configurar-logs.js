...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            await interaction.reply({ content: `El canal de logs ha sido configurado a ${logChannel}.`, flags: [MessageFlags.Ephemeral] });
        } catch (error) {
            console.error('Error al configurar el canal de logs:', error);
            await interaction.reply({ content: 'Hubo un error al intentar configurar el canal de logs.', flags: [MessageFlags.Ephemeral] });
        }
    },
};